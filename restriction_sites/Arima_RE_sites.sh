...
WORK_PATH="/data/namekawa_hpc/HiC_TBR/code_etc"  # Can change via hard coding
...
python ${WORK_PATH}"/juicer/misc/generate_site_positions.py" \
Arima \
mm10 \
${WORK_PATH}"/juicer/references/mm10.fa"
